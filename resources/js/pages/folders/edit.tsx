...
import { index as foldersIndex, update } from '@/routes/folders';
...
export default function FolderEdit({ folder }: Props) {
    const [designerSections, setDesignerSections] = useState<DesignerSection[]>(() =>
        parseFolderFieldsToDesigner((folder.fields ?? {}) as Record<string, unknown>),
    );
